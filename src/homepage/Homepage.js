...
function Homepage(){
    ...
    function handleChangeSlide(newSlide) {
        setSlide(slide+10);
        setTimeout(()=>setSlide(newSlide),250)
    }
    ...
    return(
        <div>
            <div className="content">
                <img className="arrow" src={LeftArrow} onClick={() => handleChangeSlide((slide + 2) % 4 + 1)}/>
                {slide === 1 && <img src={sources[0]} />}
                {slide === 2 && <img src={sources[1]} />}
                {slide === 3 && <img src={sources[2]} />}
                {slide === 4 && <img src={sources[3]} />}
                {slide === 11 && <img src={sources[0]} />}
                {slide === 12 && <img src={sources[1]} />}
                {slide === 13 && <img src={sources[2]} />}
                {slide === 14 && <img src={sources[3]} />}
                <div className="text-content">
                    {slide === 1 && <p className="text-entrance">{content[0]}</p>}
                    {slide === 2 && <p className="text-entrance">{content[1]}</p>}
                    {slide === 3 && <p className="text-entrance">{content[2]}</p>}
                    {slide === 4 && <p className="text-entrance">{content[3]}</p>}
                    {slide === 11 && <p className="text-exit">{content[0]}</p>}
                    {slide === 12 && <p className="text-exit">{content[1]}</p>}
                    {slide === 13 && <p className="text-exit">{content[2]}</p>}
                    {slide === 14 && <p className="text-exit">{content[3]}</p>}
                </div>
                <img className="arrow" src={RightArrow}  onClick={() => handleChangeSlide(slide % 4+1)}/>
            </div>
            <form className="radio">
                <img src = {slide === 1 ? FilledBubble: EmptyBubble} onClick = {() => handleChangeSlide(1)}/>
                <img src = {slide === 2 ? FilledBubble: EmptyBubble} onClick = {() => handleChangeSlide(2)}/>
                <img src = {slide === 3 ? FilledBubble: EmptyBubble} onClick = {() => handleChangeSlide(3)}/>
                <img src = {slide === 4 ? FilledBubble: EmptyBubble} onClick = {() => handleChangeSlide(4)}/>
            </form>
        </div>
    )
}
